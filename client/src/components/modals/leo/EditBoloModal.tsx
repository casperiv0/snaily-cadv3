...
import { updateBoloById } from "../../../lib/actions/bolos";
...
const PlateSearchModal: React.FC<Props> = ({ bolo, updateBoloById }) => {
...
export default connect(null, { updateBoloById })(PlateSearchModal);
