...
export const requestExpungement =
  (citizenId: string, data: RequestData) => async (dispatch: Dispatch<RequestExpungement>) => {
    try {
...
export const getExpungementRequests =
  (headers?: any) => async (dispatch: Dispatch<GetExpungementRequests>) => {
    try {
