...
async function updateDb() {
  updateLine("ALTER TABLE `taxi_calls` ADD `claimed` varchar(255) NOT NULL AFTER `location`;");
  updateLine("ALTER TABLE `tow_calls` ADD `claimed` varchar(255) NOT NULL AFTER `location`;");
